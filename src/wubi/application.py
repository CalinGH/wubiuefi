...
class Wubi(object):
    ...
    def parse_commandline_arguments(self):
        ...
        parser.add_option("--nobittorrent", action="store_true", dest="no_bittorrent", help="Do not use the bittorrent downloader (kept for compatibility; bittorrent is off by default)")
        parser.add_option("--bittorrent", action="store_true", dest="use_bittorrent", help="Opt in to the (experimental, not yet Python 3 ready) bittorrent downloader; HTTP is used otherwise")
